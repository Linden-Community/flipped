...
public interface PossClient {
    ...
    /**
     * Random generate a new AES key.
     * @return AES key.
     */
    String generateAesKey();

    /**
     * Encrypt the data from input stream with aes key.
     * @param inputStream The input stream which contains raw data.
     * @param aesKey key for AES encryption. It can be generated by {@link PossClient#generateAesKey()}
     * @param listener The listener which can react to process events. It can be null.
     * @return Async input stream which will contain encrypted data.
     */
    Future<InputStream> encryptData(InputStream inputStream, String aesKey, ProcessListener<InputStream> listener);

    /**
     * Decrypt the data from input stream with aes key.
     * @param inputStream The input stream which contains encrypted data.
     * @param aesKey key for AES encryption. It can be got from {@link PossClient#getProof(String, String)}
     * @param listener The listener which can react to process events. It can be null.
     * @return Async input stream which will contain decrypted data.
     */
    Future<InputStream> decryptData(InputStream inputStream, String aesKey, ProcessListener<InputStream> listener);
     ...
     * @throws Exception When network communication fail or encrypting fail.
     */
    String addProof(FileInfo fileInfo, String privateKeyStr) throws Exception;
